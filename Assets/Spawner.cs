...
public class Spawner : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < playerCount; i++)
        {
            ...
            minoIndex = 4 * random.NextInt(0,6), minos = 4, piecePos = new int2(4,21), pieceSpawned = true, posToMove = int2.zero, random = new Unity.Mathematics.Random(random.NextUInt()), 
